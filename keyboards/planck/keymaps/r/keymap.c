...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F5, KC_F6,  KC_F7,  KC_F8,   XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX, KC_MUTE,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  _______, _______, BASE,    COLEMAK, DVORAK,  PLOVER,  _______,
